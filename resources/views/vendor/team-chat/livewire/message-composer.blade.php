<div class="border-t border-gray-200 dark:border-gray-700 p-2 sm:p-4">
    @if($messageableId)
        <div class="relative">
            {{-- Mention suggestions --}}
            @if($showMentionSuggestions)
                <div class="absolute bottom-full left-0 mb-1 w-64 max-w-[calc(100vw-2rem)] rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 shadow-lg overflow-hidden z-10">
                    <button
